...
public class ECJPAKECurve
{
     ...
     *  q must be prime</li>
     *  n must be prime</li>
     *  The curve must not be singular i.e. the discriminant is equal to 0 mod q</li>
     *  G must lie on the curve</li>
     *  n*h must equal the order of the curve</li>
     *  a must be in [0, q-1]</li>
     *  b must be in [0, q-1]</li>
     * </ul>
     * <p>
