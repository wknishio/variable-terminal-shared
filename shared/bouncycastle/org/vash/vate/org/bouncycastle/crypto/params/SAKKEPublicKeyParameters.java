 ...
 *  
 *    Prime modulus {@code p} defining the field F_p</li>
 *    Subgroup order {@code q} (divides p+1)</li>
 *    Base point {@code P} on the elliptic curve E(F_p)</li>
 *    Pairing result {@code g =  }</li>
 *    KMS Public Key {@code Z_S = [z_S]P}</li>
 *    Security parameter {@code n} (SSV bit length)</li>
 *    User Identifier</li>
 *    Elliptic curve parameters (a = -3, b = 0)</li>
 * </ul>
 * </p>
 * <p>
