package org.vash.vate.org.bouncycastle.crypto.agreement.ecjpake;
 ...
 *  {@link #validateRound1PayloadReceived(ECJPAKERound1Payload)} - use the payload received from the other participant</li>
 *  {@link #createRound2PayloadToSend()} - and send the payload to the other participant</li>
 *  {@link #validateRound2PayloadReceived(ECJPAKERound2Payload)} - use the payload received from the other participant</li>
 ...
 *  {@link #validateRound3PayloadReceived(ECJPAKERound3Payload, BigInteger)} - use the payload received from the other participant</li>
 * </ol>
 * <p>
...
public class ECJPAKEParticipant
{
     ...
     * rounds 3 and 4.
     * <p>
     * The keying material will be in the range  [0, n-1]</tt>.
     * <p>
