...
import org.vash.vate.org.bouncycastle.jcajce.interfaces.BCKey;
    ...
    implements RSAPrivateKey, PKCS12BagAttributeCarrier, BCKey
{
    ...
    BCRSAPrivateKey(AlgorithmIdentifier algID, org.vash.vate.org.bouncycastle.asn1.pkcs.RSAPrivateKey key)
    {
        this.algorithmIdentifier = algID;
        this.algorithmIdentifierEnc = getEncoding(algID);
    ...
    {
        return KeyUtil.getEncodedPrivateKeyInfo(algorithmIdentifier, new org.vash.vate.org.bouncycastle.asn1.pkcs.RSAPrivateKey(getModulus(), ZERO, getPrivateExponent(), ZERO, ZERO, ZERO, ZERO, ZERO));
    }
