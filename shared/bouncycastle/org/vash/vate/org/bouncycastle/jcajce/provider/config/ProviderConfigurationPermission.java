package org.vash.vate.org.bouncycastle.jcajce.provider.config;
 ...
 * Examples:
 *  
 *  ProviderConfigurationPermission("BC"); // enable all permissions</li>
 *  ProviderConfigurationPermission("BC", "threadLocalEcImplicitlyCa"); // enable thread local only</li>
 *  ProviderConfigurationPermission("BC", "ecImplicitlyCa"); // enable global setting only</li>
 *  ProviderConfigurationPermission("BC", "threadLocalEcImplicitlyCa, ecImplicitlyCa"); // enable both explicitly</li>
 * </ul>
 * <p>
