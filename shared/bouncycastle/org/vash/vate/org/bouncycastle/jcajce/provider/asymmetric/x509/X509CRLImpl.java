...
import org.vash.vate.org.bouncycastle.asn1.x509.CRLNumber;
            ...
            while (certs.hasMoreElements())
            {
                ...
                if (entry.getUserCertificate().hasValue(serial))
                {
                    ...
                    else
                    {
                        try
                        {
                            issuer = org.vash.vate.org.bouncycastle.asn1.x509.Certificate.getInstance(cert.getEncoded()).getIssuer();
                        }
