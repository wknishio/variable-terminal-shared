package org.vash.vate.org.bouncycastle.jcajce.provider.asymmetric.util;
...
import org.vash.vate.org.bouncycastle.asn1.anssi.ANSSINamedCurves;
import org.vash.vate.org.bouncycastle.asn1.cryptopro.ECGOST3410NamedCurves;
import org.vash.vate.org.bouncycastle.asn1.gm.GMNamedCurves;
import org.vash.vate.org.bouncycastle.asn1.nist.NISTNamedCurves;
import org.vash.vate.org.bouncycastle.asn1.pkcs.PrivateKeyInfo;
import org.vash.vate.org.bouncycastle.asn1.sec.SECNamedCurves;
import org.vash.vate.org.bouncycastle.asn1.teletrust.TeleTrusTNamedCurves;
import org.vash.vate.org.bouncycastle.asn1.x509.SubjectPublicKeyInfo;
import org.vash.vate.org.bouncycastle.asn1.x9.ECNamedCurveTable;
import org.vash.vate.org.bouncycastle.asn1.x9.X962NamedCurves;
import org.vash.vate.org.bouncycastle.asn1.x9.X962Parameters;
import org.vash.vate.org.bouncycastle.asn1.x9.X9ECParameters;
import org.vash.vate.org.bouncycastle.crypto.ec.CustomNamedCurves;
...
import org.vash.vate.org.bouncycastle.crypto.params.ECNamedDomainParameters;
...
import org.vash.vate.org.bouncycastle.jcajce.provider.config.ProviderConfiguration;
import org.vash.vate.org.bouncycastle.jce.interfaces.ECPrivateKey;
import org.vash.vate.org.bouncycastle.jce.interfaces.ECPublicKey;
import org.vash.vate.org.bouncycastle.jce.provider.BouncyCastleProvider;
import org.vash.vate.org.bouncycastle.jce.spec.ECNamedCurveParameterSpec;
import org.vash.vate.org.bouncycastle.jce.spec.ECParameterSpec;
...
import org.vash.vate.org.bouncycastle.util.Fingerprint;
import org.vash.vate.org.bouncycastle.util.Strings;

/**
 * utility class for converting jce/jca ECDSA, ECDH, and ECDHC
 * objects into their org.vash.vate.org.bouncycastle.crypto counterparts.
 */
public class ECUtil
{
    /**
    ...
    public static ECDomainParameters getDomainParameters(
        ...
        org.vash.vate.org.bouncycastle.jce.spec.ECParameterSpec params)
    {
        ...
        {
            org.vash.vate.org.bouncycastle.jce.spec.ECParameterSpec iSpec = configuration.getEcImplicitlyCa();
    ...
    public static String privateKeyToString(String algorithm, BigInteger d, org.vash.vate.org.bouncycastle.jce.spec.ECParameterSpec spec)
    {
        StringBuffer buf = new StringBuffer();
        String nl = Strings.lineSeparator();

        org.vash.vate.org.bouncycastle.math.ec.ECPoint q = new FixedPointCombMultiplier().multiply(spec.getG(), d).normalize();
    ...
    public static String publicKeyToString(String algorithm, org.vash.vate.org.bouncycastle.math.ec.ECPoint q, org.vash.vate.org.bouncycastle.jce.spec.ECParameterSpec spec)
    {
        StringBuffer buf = new StringBuffer();
        String nl = Strings.lineSeparator();
    ...
    public static String generateKeyFingerprint(ECPoint publicPoint, org.vash.vate.org.bouncycastle.jce.spec.ECParameterSpec spec)
    {
