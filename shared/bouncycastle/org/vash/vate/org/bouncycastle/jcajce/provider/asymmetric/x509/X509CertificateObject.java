    ...
    implements PKCS12BagAttributeCarrier
{
    ...
    X509CertificateObject(JcaJceHelper bcHelper, org.vash.vate.org.bouncycastle.asn1.x509.Certificate c)
    ...
    private static BasicConstraints createBasicConstraints(org.vash.vate.org.bouncycastle.asn1.x509.Certificate c)
        throws CertificateParsingException
    {
        try
        {
    ...
    private static boolean[] createKeyUsage(org.vash.vate.org.bouncycastle.asn1.x509.Certificate c) throws CertificateParsingException
    {
        try
        {
    ...
    private static String createSigAlgName(org.vash.vate.org.bouncycastle.asn1.x509.Certificate c) throws CertificateParsingException
    {
        try
        {
    ...
    private static byte[] createSigAlgParams(org.vash.vate.org.bouncycastle.asn1.x509.Certificate c) throws CertificateParsingException
    {
        try
        {
