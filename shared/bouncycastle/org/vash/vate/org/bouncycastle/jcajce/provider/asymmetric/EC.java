...
import org.vash.vate.org.bouncycastle.internal.asn1.bsi.BSIObjectIdentifiers;
import org.vash.vate.org.bouncycastle.internal.asn1.cms.CMSObjectIdentifiers;
import org.vash.vate.org.bouncycastle.internal.asn1.eac.EACObjectIdentifiers;
import org.vash.vate.org.bouncycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi;
...
public class EC
{
    ...
    private static final Map  ecSupportCurves = new HashMap ();
    ...
    static
    {
        ...
        while (names.hasMoreElements())
        {
            ...
            ECNamedCurveParameterSpec spec = org.vash.vate.org.bouncycastle.jce.ECNamedCurveTable.getParameterSpec(name);
            if (spec == null)
            {
                continue;
            }
