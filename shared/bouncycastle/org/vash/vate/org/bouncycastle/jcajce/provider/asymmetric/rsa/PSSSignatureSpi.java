    ...
    extends Signature
{
    ...
    private org.vash.vate.org.bouncycastle.crypto.signers.PSSSigner pss;
        ...
        int trailerField)
    {
        if (trailerField == 1)
        {
            return org.vash.vate.org.bouncycastle.crypto.signers.PSSSigner.TRAILER_IMPLICIT;
        }
        ...
        throws InvalidKeyException
    {
        ...
        pss = new org.vash.vate.org.bouncycastle.crypto.signers.PSSSigner(signer, contentDigest, mgfDigest, saltLength);
        pss.init(false,
