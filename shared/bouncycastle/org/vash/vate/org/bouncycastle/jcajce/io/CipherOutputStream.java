package org.vash.vate.org.bouncycastle.jcajce.io;
...
import org.vash.vate.org.bouncycastle.crypto.io.InvalidCipherTextIOException;
    ...
    extends FilterOutputStream
{
    ...
    /**
     * Writes  len</code> bytes from the specified byte array starting at offset
     *  off</code> to this output stream.
     *
     * @param b   the data.
     ...
     * of bytes written using one of the  write</code> methods is less than the cipher's block
     ...
     * <p>
     * This method invokes the  doFinal</code> method of the encapsulated cipher object, which
     * causes any bytes buffered by the encapsulated cipher to be processed. The result is written
     * out by calling the  flush</code> method of this output stream.
     * </p><p>
