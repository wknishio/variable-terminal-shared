    ...
    implements RSAPublicKey, BCKey
{
    ...
    private void populateFromPublicKeyInfo(SubjectPublicKeyInfo info)
    {
        try
        {
            org.vash.vate.org.bouncycastle.asn1.pkcs.RSAPublicKey  pubKey = org.vash.vate.org.bouncycastle.asn1.pkcs.RSAPublicKey.getInstance(info.parsePublicKey());
    ...
    {
        return KeyUtil.getEncodedSubjectPublicKeyInfo(algorithmIdentifier, new org.vash.vate.org.bouncycastle.asn1.pkcs.RSAPublicKey(getModulus(), getPublicExponent()));
    }
