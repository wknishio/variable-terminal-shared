package org.vash.vate.org.bouncycastle.jcajce.provider.keystore.bcfks;
...
import org.vash.vate.org.bouncycastle.asn1.bc.EncryptedObjectStoreData;
import org.vash.vate.org.bouncycastle.asn1.bc.EncryptedPrivateKeyData;
import org.vash.vate.org.bouncycastle.asn1.bc.EncryptedSecretKeyData;
import org.vash.vate.org.bouncycastle.asn1.bc.ObjectData;
import org.vash.vate.org.bouncycastle.asn1.bc.ObjectDataSequence;
import org.vash.vate.org.bouncycastle.asn1.bc.ObjectStore;
import org.vash.vate.org.bouncycastle.asn1.bc.ObjectStoreData;
import org.vash.vate.org.bouncycastle.asn1.bc.ObjectStoreIntegrityCheck;
import org.vash.vate.org.bouncycastle.asn1.bc.PbkdMacIntegrityCheck;
import org.vash.vate.org.bouncycastle.asn1.bc.SecretKeyData;
import org.vash.vate.org.bouncycastle.internal.asn1.cms.CCMParameters;
import org.vash.vate.org.bouncycastle.internal.asn1.misc.MiscObjectIdentifiers;
import org.vash.vate.org.bouncycastle.internal.asn1.misc.ScryptParams;
import org.vash.vate.org.bouncycastle.asn1.nist.NISTObjectIdentifiers;
import org.vash.vate.org.bouncycastle.internal.asn1.oiw.OIWObjectIdentifiers;
import org.vash.vate.org.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo;
import org.vash.vate.org.bouncycastle.asn1.pkcs.EncryptionScheme;
import org.vash.vate.org.bouncycastle.asn1.pkcs.KeyDerivationFunc;
import org.vash.vate.org.bouncycastle.asn1.pkcs.PBES2Parameters;
import org.vash.vate.org.bouncycastle.asn1.pkcs.PBKDF2Params;
...
import org.vash.vate.org.bouncycastle.asn1.x9.X9ObjectIdentifiers;
...
import org.vash.vate.org.bouncycastle.crypto.generators.PKCS5S2ParametersGenerator;
import org.vash.vate.org.bouncycastle.crypto.generators.SCrypt;
import org.vash.vate.org.bouncycastle.crypto.params.KeyParameter;
import org.vash.vate.org.bouncycastle.crypto.util.PBKDF2Config;
import org.vash.vate.org.bouncycastle.crypto.util.PBKDFConfig;
import org.vash.vate.org.bouncycastle.crypto.util.ScryptConfig;
import org.vash.vate.org.bouncycastle.jce.provider.BouncyCastleProvider;
    ...
    extends KeyStoreSpi
{
    ...
    public Certificate[] engineGetCertificateChain(String alias)
    {
        ...
        if (ent != null)
        {
            ...
            {
                EncryptedPrivateKeyData encPrivData = EncryptedPrivateKeyData.getInstance(ent.getData());
                org.vash.vate.org.bouncycastle.asn1.x509.Certificate[] certificates = encPrivData.getCertificateChain();
    ...
    private Certificate decodeCertificate(Object cert)
    {
        if (provider != null)
        {
            try
            {
                ...
                return certFact.generateCertificate(new ByteArrayInputStream(org.vash.vate.org.bouncycastle.asn1.x509.Certificate.getInstance(cert).getEncoded()));
            }
            catch (Exception e)
            {
                return null;
    ...
    {
        org.vash.vate.org.bouncycastle.asn1.x509.Certificate[] certChain = new org.vash.vate.org.bouncycastle.asn1.x509.Certificate[chain.length];
        for (int i = 0; i != chain.length; i++)
        {
            certChain[i] = org.vash.vate.org.bouncycastle.asn1.x509.Certificate.getInstance(chain[i].getEncoded());
        }
