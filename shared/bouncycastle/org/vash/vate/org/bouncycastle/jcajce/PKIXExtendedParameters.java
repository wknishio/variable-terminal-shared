    ...
    implements CertPathParameters
{
     ...
     * {@link PKIXParameters#setDate(Date)} method, so this methods sets the Date when  all</em>
     ...
     * method sets the time, when the  end certificate</em> must have been valid. It is used e.g.
