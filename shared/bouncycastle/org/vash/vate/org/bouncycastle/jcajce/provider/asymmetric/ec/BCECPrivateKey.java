package org.vash.vate.org.bouncycastle.jcajce.provider.asymmetric.ec;
...
import org.vash.vate.org.bouncycastle.asn1.sec.ECPrivateKeyStructure;
...
import org.vash.vate.org.bouncycastle.jcajce.provider.asymmetric.util.ECUtil;
import org.vash.vate.org.bouncycastle.jcajce.provider.asymmetric.util.KeyUtil;
import org.vash.vate.org.bouncycastle.jcajce.provider.asymmetric.util.PKCS12BagAttributeCarrierImpl;
import org.vash.vate.org.bouncycastle.jcajce.provider.config.ProviderConfiguration;
import org.vash.vate.org.bouncycastle.jce.interfaces.ECPointEncoder;
...
import org.vash.vate.org.bouncycastle.jce.spec.ECPrivateKeySpec;
    ...
    implements ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public byte[] getEncoded()
    {
        ...
        PrivateKeyInfo          info;
        org.vash.vate.org.bouncycastle.asn1.sec.ECPrivateKey            keyStructure;

        if (publicKey != null)
        {
            keyStructure = new org.vash.vate.org.bouncycastle.asn1.sec.ECPrivateKey(orderBitLength, this.getD(), publicKey, params);
        }
        else
        {
            keyStructure = new org.vash.vate.org.bouncycastle.asn1.sec.ECPrivateKey(orderBitLength, this.getD(), params);
        }
    ...
    {
        org.vash.vate.org.bouncycastle.jce.interfaces.ECPrivateKey k = (org.vash.vate.org.bouncycastle.jce.interfaces.ECPrivateKey)key;
        org.vash.vate.org.bouncycastle.jce.spec.ECParameterSpec s = k.getParameters();
