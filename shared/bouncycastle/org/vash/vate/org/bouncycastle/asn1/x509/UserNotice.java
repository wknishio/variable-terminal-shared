...
/**
 *  UserNotice</code> class, used in
 *  CertificatePolicies</code> X509 extensions (in policy
 * qualifiers).
 *  
 * UserNotice ::= SEQUENCE {
    ...
    extends ASN1Object
{
    ...
    /**
     * Creates a new  UserNotice</code> instance.
     *
     * @param noticeRef a  NoticeReference</code> value
     * @param explicitText a  DisplayText</code> value
     */
    public UserNotice(
    ...
    /**
     * Creates a new  UserNotice</code> instance.
     * <p>Useful from reconstructing a  UserNotice</code> instance
     * from its encodable/encoded form. 
     *
     * @param as an  ASN1Sequence</code> value obtained from either
     * calling @{link toASN1Primitive()} for a  UserNotice</code>
