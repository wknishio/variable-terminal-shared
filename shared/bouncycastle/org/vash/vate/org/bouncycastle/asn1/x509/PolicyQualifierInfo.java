    ...
    extends ASN1Object
{
   ...
   /**
    * Creates a new  PolicyQualifierInfo</code> instance.
    *
    * @param policyQualifierId a  PolicyQualifierId</code> value
   ...
   /**
    * Creates a new  PolicyQualifierInfo</code> containing a
    * cPSuri qualifier.
    *
    ...
    * Creates a new  PolicyQualifierInfo</code> instance.
    *
    * @param as  PolicyQualifierInfo</code> X509 structure
