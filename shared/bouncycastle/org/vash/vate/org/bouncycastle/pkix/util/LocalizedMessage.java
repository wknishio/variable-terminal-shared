package org.vash.vate.org.bouncycastle.pkix.util;
...
import org.vash.vate.org.bouncycastle.pkix.util.filter.Filter;
import org.vash.vate.org.bouncycastle.pkix.util.filter.TrustedInput;
import org.vash.vate.org.bouncycastle.pkix.util.filter.UntrustedInput;
import org.vash.vate.org.bouncycastle.pkix.util.filter.UntrustedUrlInput;
...
public class LocalizedMessage 
{
    ...
    /**
     * Constructs a new LocalizedMessage using  resource</code> as the base name for the 
     * RessourceBundle and  id</code> as the message bundle id the resource file. 
     * @param resource base name of the resource file 
     * @param id the id of the corresponding bundle in the resource file
     * @throws NullPointerException if  resource</code> or  id</code> is  null</code>
     */
    ...
    /**
     * Reads the entry  id + "." + key</code> from the resource file and returns a 
     ...
     * @param filter the {@link Filter} to use.  null</code> to disable filtering.
     */
    ...
    /**
     * Set the {@link ClassLoader} which loads the resource files. If it is set to  null</code>
    ...
    /**
     * Returns the {@link ClassLoader} which loads the resource files or  null</code>
    ...
    /**
     * Returns an  Object[]</code> containing the message arguments.
