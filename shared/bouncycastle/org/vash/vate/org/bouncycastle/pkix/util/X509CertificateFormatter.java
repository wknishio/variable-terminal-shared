...
import org.vash.vate.org.bouncycastle.operator.DefaultSignatureNameFinder;
...
{
    private static Map  oidMap = new HashMap ();
    private static Map  keyAlgMap = new HashMap ();
    private static Map  extUsageMap = new HashMap ();
                ...
                if (ext.getExtnValue() != null)
                {
                    ...
                    try
                    {
                        ...
                        else if (oid.equals(Extension.extendedKeyUsage))
                        {
                            ...
                            buf.append(pad);
                            boolean first = true;
                            for (Iterator  it = extUsageMap.keySet().iterator(); it.hasNext(); )
                            {
