package org.vash.vate.org.bouncycastle.jce;
    ...
    implements X509StoreParameters, CertStoreParameters
{
    ...
    public static class Builder
    {
         ...
         *                                       if  null</code>.
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         */
         ...
         *                                       "authorityRevocationList" if  null</code>.
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         */
         ...
         *                                       "attributeCertificateAttribute" if  null</code>.
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         */
         ...
         *                                       by space. Defaults to "aACertificate" if  null</code>.
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         */
         ...
         *                                       "attributeDescriptorCertificate" if  null</code>.
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         */
         ...
         *                                       Separated by space. Defaults to
         *                                       "attributeAuthorityRevocationList" if  null</code>.
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         */
         ...
         *                                        userCertificateSubjectAttributeName</code>. E.g. if
         ...
         *                                       for the attribute value of the specified
         *                                        cACertificateSubjectAttributeName</code>. E.g. if
         ...
         *                                        crossCertificateSubjectAttributeName</code>. E.g. if
         ...
         *                                       The attribute name(s) in the LDAP directory where to search for
         *                                       the attribute value of the specified
         *                                        certificateRevocationListIssuerAttributeName</code>.
         ...
         *                                       The attribute name(s) in the LDAP directory where to search for
         *                                       the attribute value of the specified
         *                                        deltaRevocationListIssuerAttributeName</code>. E.g.
         ...
         *                                       The attribute name(s) in the LDAP directory where to search for
         *                                       the attribute value of the specified
         *                                        authorityRevocationListIssuerAttributeName</code>.
         *                                       E.g. if "ou" is used to put information about the issuer of
         *                                       CRLs, specify "ou".
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         ...
         *                                       The attribute name(s) in the LDAP directory where to search for
         *                                       the attribute value of the specified
         *                                        attributeCertificateAttributeSubjectAttributeName</code>.
         ...
         *                                       the attribute value of the specified
         *                                        aACertificateSubjectAttributeName</code>. E.g. if
         ...
         *                                       The attribute name(s) in the LDAP directory where to search for
         *                                       the attribute value of the specified
         *                                        attributeDescriptorCertificateSubjectAttributeName</code>.
         ...
         *                                       The attribute name(s) in the LDAP directory where to search for
         *                                       the attribute value of the specified
         *                                        attributeCertificateRevocationListIssuerAttributeName</code>.
         *                                       E.g. if "ou" is used to put information about the issuer of
         *                                       CRLs, specify "ou".
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         ...
         *                                       The attribute name(s) in the LDAP directory where to search for
         *                                       the attribute value of the specified
         *                                        attributeAuthorityRevocationListIssuerAttributeName</code>.
         *                                       E.g. if "ou" is used to put information about the issuer of
         *                                       CRLs, specify "ou".
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         ...
         *                                        ldapUserCertificateAttributeName</code>. E.g. the
         ...
         *                                       Attribute(s) in the subject of the certificate which is used
         *                                       to be searched in the
         *                                        ldapCACertificateAttributeName</code>. E.g. the "ou"
         ...
         *                                        ldapCrossCertificateAttributeName</code>. E.g. the
         ...
         *                                       searched in the
         *                                        ldapCertificateRevocationListAttributeName</code>.
         ...
         *                                       Attribute(s) in the issuer of the CRL which is used to be
         *                                       searched in the
         *                                        ldapDeltaRevocationListAttributeName</code>. E.g. the
         ...
         *                                       Attribute(s) in the issuer of the CRL which is used to be
         *                                       searched in the
         *                                        ldapAuthorityRevocationListAttributeName</code>. E.g.
         ...
         *                                        ldapAttributeCertificateAttributeAttributeName</code>.
         ...
         *                                       Attribute(s) in the subject of the attribute certificate which
         *                                       is used to be searched in the
         *                                        ldapAACertificateAttributeName</code>. E.g. the "ou"
         *                                       attribute of the DN could be used.
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         */
         ...
         *                                       Attribute(s) in the subject of the attribute certificate which
         *                                       is used to be searched in the
         *                                        ldapAttributeDescriptorCertificateAttributeName</code>.
         ...
         *                                       Attribute(s) in the issuer of the CRL which is used to be
         *                                       searched in the
         *                                        ldapAttributeCertificateRevocationListAttributeName</code>.
         *                                       E.g. the "o" or "ou" attribute may be used
         ...
         *                                       searched in the
         *                                        ldapAttributeAuthorityRevocationListAttributeName</code>.
         *                                       E.g. the "o" or "ou" attribute may be used.
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         */
        ...
        /**
         *
         * @param searchForSerialNumberIn        If not  null</code> the serial number of the
         *                                       certificate is searched in this LDAP attribute.
         * @throws IllegalArgumentException if a necessary parameter is  null</code>.
         * @return the builder
         */
