...
class ReasonsMask
{
    ...
    /**
     * Returns  true</code> if this reasons mask contains all possible
     * reasons.
     * 
     * @return  true</code> if this reasons mask contains all possible
     *         reasons.
     */
    ...
    /**
     * Returns  true</code> if the passed reasons mask has new reasons.
     * 
     * @param mask The reasons mask which should be tested for new reasons.
     * @return  true</code> if the passed reasons mask has new reasons.
     */
