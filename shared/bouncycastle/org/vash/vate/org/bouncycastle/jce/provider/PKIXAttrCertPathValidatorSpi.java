...
import org.vash.vate.org.bouncycastle.x509.ExtendedPKIXParameters;
 ...
 * 
 * @see org.vash.vate.org.bouncycastle.x509.ExtendedPKIXParameters
 */
    ...
    extends CertPathValidatorSpi
{
     ...
     * 
     * <p>
     *  params</code> must be an instance of
     *  ExtendedPKIXParameters</code>.
     * <p>
     * The target constraints in the  params</code> must be an
     *  X509AttributeCertStoreSelector</code> with at least the attribute
     * certificate criterion set. Obey that also target informations may be
     * necessary to correctly validate this attribute certificate.
     * <p>
     * The attribute certificate issuer must be added to the trusted attribute
     * issuers with {@link org.vash.vate.org.bouncycastle.x509.ExtendedPKIXParameters#setTrustedACIssuers(java.util.Set)}.
     * 
     * @param certPath The certificate path which belongs to the attribute
     *            certificate issuer public key certificate.
     * @param params The PKIX parameters.
     * @return A  PKIXCertPathValidatorResult</code> of the result of
     *         validating the  certPath</code>.
     * @throws java.security.InvalidAlgorithmParameterException if  params</code> is
