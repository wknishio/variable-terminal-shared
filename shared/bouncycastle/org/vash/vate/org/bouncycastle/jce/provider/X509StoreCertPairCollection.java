 ...
 * {@link org.vash.vate.org.bouncycastle.x509.X509Store} SPI implementation for certificate
 * pairs.
 *
 * @see org.vash.vate.org.bouncycastle.x509.X509Store
 * @see org.vash.vate.org.bouncycastle.x509.X509CertificatePair
 */
public class X509StoreCertPairCollection extends X509StoreSpi
{
     ...
     * @throws IllegalArgumentException if  params</code> is no instance of
     *                                   X509CollectionStoreParameters</code>.
     */
     ...
     * {@link org.vash.vate.org.bouncycastle.x509.X509CertificatePair}s. The selector must be
     * a {@link org.vash.vate.org.bouncycastle.x509.X509CertPairStoreSelector} to select
     * certificate pairs.
     * </p>
