...
import org.vash.vate.org.bouncycastle.asn1.dvcs.ServiceType;
...
public class DVCSRequest
    extends DVCSMessage
{
    private org.vash.vate.org.bouncycastle.asn1.dvcs.DVCSRequest asn1;
        ...
        throws DVCSConstructionException
    {
        ...
        try
        {
            ...
            {
                this.asn1 = org.vash.vate.org.bouncycastle.asn1.dvcs.DVCSRequest.getInstance(contentInfo.getContent());
            }
            else
            {
                this.asn1 = org.vash.vate.org.bouncycastle.asn1.dvcs.DVCSRequest.getInstance(ASN1OctetString.getInstance(contentInfo.getContent()).getOctets());
            }
        }
        catch (Exception e)
        {
     ...
     *
     * @return an org.vash.vate.org.bouncycastle.asn1.dvcs.DVCSRequest object.
     */
