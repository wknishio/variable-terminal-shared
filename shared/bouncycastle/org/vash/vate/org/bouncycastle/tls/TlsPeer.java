...
public interface TlsPeer
{
     ...
     * (see RFC 7627 5.4).
     * 
     * @return  true</code> if the handshake should be aborted when the peer does not negotiate
     *         the extended_master_secret extension, or  false</code> to support legacy
     *         interoperability.
     */
     ...
     * 
     * @return  true</code> if the 'signatureAlgorithm' of received certificates should be
     *         checked, or  false</code> to skip those checks.
     *
     ...
     * 
     * @return  true</code> if random extra padding should be added during block cipher
     *         encryption, or  false</code> to always use the minimum amount of required
     *         padding.
     */
     ...
     * 
     * @return  true</code> if the current time should be used in the gmt_unix_time field of
     *         Random, or  false</code> if gmt_unix_time should contain a cryptographically
     *         random value.
     */
