...
import org.vash.vate.org.bouncycastle.crypto.engines.RSAEngine;
...
import org.vash.vate.org.bouncycastle.pqc.crypto.mldsa.MLDSASigner;
...
import org.vash.vate.org.bouncycastle.tls.crypto.TlsCertificateRole;
...
import org.vash.vate.org.bouncycastle.tls.crypto.impl.LegacyTls13Verifier;
import org.vash.vate.org.bouncycastle.tls.crypto.impl.PQCUtil;
import org.vash.vate.org.bouncycastle.tls.crypto.impl.RSAUtil;
...
//        }
    ...
    protected AsymmetricKeyParameter getPQCPublicKey() throws IOException
    {
        try
        {
            return org.vash.vate.org.bouncycastle.pqc.crypto.util.PublicKeyFactory.createKey(keyInfo);
        }
