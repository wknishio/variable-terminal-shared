...
import org.vash.vate.org.bouncycastle.tls.Certificate;
import org.vash.vate.org.bouncycastle.tls.ProtocolVersion;
import org.vash.vate.org.bouncycastle.tls.TlsCredentialedDecryptor;
    ...
    implements TlsCredentialedDecryptor
{
        ...
        RSAKeyParameters rsaServerPrivateKey, byte[] encryptedPreMasterSecret)
    {
        ...
        byte[] preMasterSecret = org.vash.vate.org.bouncycastle.crypto.tls.TlsRsaKeyExchange.decryptPreMasterSecret(
