...
import org.vash.vate.org.bouncycastle.cms.CMSEncryptedData;
...
public class PKCS12SafeBagFactory
{
        ...
        throws PKCSException
    {
        if (info.getContentType().equals(PKCSObjectIdentifiers.encryptedData))
        {
            CMSEncryptedData encData = new CMSEncryptedData(org.vash.vate.org.bouncycastle.asn1.cms.ContentInfo.getInstance(info));
