...
import org.vash.vate.org.bouncycastle.asn1.x509.Holder;
import org.vash.vate.org.bouncycastle.asn1.x509.IssuerSerial;
import org.vash.vate.org.bouncycastle.asn1.x509.ObjectDigestInfo;
import org.vash.vate.org.bouncycastle.jce.PrincipalUtil;
 ...
 *          }
 * </pre>
 * @deprecated use org.vash.vate.org.bouncycastle.cert.AttributeCertificateHolder
 */
    ...
    implements CertSelector, Selector
{
    ...
    {
        holder = new org.vash.vate.org.bouncycastle.asn1.x509.Holder(new IssuerSerial(
     ...
     * some type of object.
     * <p>
     *  digestedObjectType</code> can be one of the following:
     *  
     ...
     * passed.  otherObjectTypeID</code> must not be empty.
     * </ul>
     * <p>
     ...
     * 
     * @return The other object type ID or  null</code> if no object
     *         digest info is set.
     */
     ...
     * 
     * @return The hash or  null</code> if no object digest info is set.
     */
     ...
     * 
     * @return The digest algorithm ID or  null</code> if no object
     *         digest info is set.
     */
