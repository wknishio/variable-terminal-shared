package org.vash.vate.org.bouncycastle.x509.util;
...
import org.vash.vate.org.bouncycastle.asn1.x509.Certificate;
import org.vash.vate.org.bouncycastle.asn1.x509.CertificatePair;
import org.vash.vate.org.bouncycastle.jce.X509LDAPCertStoreParameters;
import org.vash.vate.org.bouncycastle.jce.provider.X509AttrCertParser;
import org.vash.vate.org.bouncycastle.jce.provider.X509CRLParser;
import org.vash.vate.org.bouncycastle.jce.provider.X509CertPairParser;
import org.vash.vate.org.bouncycastle.jce.provider.X509CertParser;
import org.vash.vate.org.bouncycastle.util.StoreException;
import org.vash.vate.org.bouncycastle.x509.X509AttributeCertStoreSelector;
import org.vash.vate.org.bouncycastle.x509.X509AttributeCertificate;
import org.vash.vate.org.bouncycastle.x509.X509CRLStoreSelector;
import org.vash.vate.org.bouncycastle.x509.X509CertPairStoreSelector;
import org.vash.vate.org.bouncycastle.x509.X509CertStoreSelector;
import org.vash.vate.org.bouncycastle.x509.X509CertificatePair;
 ...
 * {@link org.vash.vate.org.bouncycastle.jce.X509LDAPCertStoreParameters} with the given
 * information of the subject (for all kind of certificates) or issuer (for
 * CRLs), respectively, if a {@link org.vash.vate.org.bouncycastle.x509.X509CertStoreSelector} or
 * {@link org.vash.vate.org.bouncycastle.x509.X509AttributeCertificate} is given with that
 * details.
 * </p><p>
 * For the used schemes see:
 *  
 *  <a href="https://www.ietf.org/rfc/rfc2587.txt">RFC 2587</a>
 *  <a
...
public class LDAPStoreHelper
{
     ...
     * {@link org.vash.vate.org.bouncycastle.x509.X509CertStoreSelector} of the given
     * selector.
     *
     * @param xselector             The selector with the search criteria.
...
*/
    ...
    /**
     * Returns a  List</code> of encodings of the certificates, attribute
     ...
     *                       entry.
     * @return A  List</code> of byte arrays with the encodings.
