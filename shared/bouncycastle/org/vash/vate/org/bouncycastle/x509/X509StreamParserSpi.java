 ...
 * X509StreamParser.
 *
 * @see org.vash.vate.org.bouncycastle.x509.X509StreamParser
 *
 */
public abstract class X509StreamParserSpi
{
     ...
     * input stream.
     *
     * @return the next X.509 object in the stream or  null</code> if the
     ...
     *          null</code> if the end of the stream is reached.
     * @exception StreamParsingException
