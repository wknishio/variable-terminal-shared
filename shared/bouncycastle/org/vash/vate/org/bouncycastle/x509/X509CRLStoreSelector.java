...
import org.vash.vate.org.bouncycastle.asn1.x509.X509Extensions;
import org.vash.vate.org.bouncycastle.util.Arrays;
import org.vash.vate.org.bouncycastle.util.Selector;
import org.vash.vate.org.bouncycastle.x509.extension.X509ExtensionUtil;
 ...
 * lists.
 * 
 * @see org.vash.vate.org.bouncycastle.util.Selector
 * @see org.vash.vate.org.bouncycastle.x509.X509Store
 * @see org.vash.vate.org.bouncycastle.jce.provider.X509StoreCRLCollection
 */
    ...
    implements Selector
{
     ...
     * 
     * @param issuingDistributionPointEnabled  true</code> to enable the
     ...
     * attribute certificate. If  null</code> is specified, then no such
     * optional information is provided.
     * 
     * @param attrCert the  X509AttributeCertificate</code> being checked (or
     *             null</code>)
     ...
     * extension set. Defaults to  false</code>.
     * 
     * @return Returns  true</code> if only CRLs with the delta CRL
    ...
    /**
     * If this is set to  true</code> the CRL reported contains the delta
     ...
     * 
     * @param deltaCRLIndicator  true</code> if the delta CRL indicator
    ...
    /**
     * Returns an instance of this from a  X509CRLSelector</code>.
     * 
     * @param selector A  X509CRLSelector</code> instance.
     * @return An instance of an  X509CRLStoreSelector</code>.
    ...
    /**
     * If  true</code> only complete CRLs are returned. Defaults to
     *  false</code>.
     * 
     * @return  true</code> if only complete CRLs are returned.
     */
    ...
    /**
     * If set to  true</code> only complete CRLs are returned.
     * <p>
     * {@link #setCompleteCRLEnabled(boolean)} and
     * {@link #setDeltaCRLIndicatorEnabled(boolean)} excluded each other.
     * 
     * @param completeCRLEnabled  true</code> if only complete CRLs
     *            should be returned.
     */
    ...
    /**
     * Get the maximum base CRL number. Defaults to  null</code>.
     * 
    ...
    /**
     * Sets the maximum base CRL number. Setting to  null</code> disables
     * this cheack.
     * <p>
    ...
    /**
     * Returns the issuing distribution point. Defaults to  null</code>,
