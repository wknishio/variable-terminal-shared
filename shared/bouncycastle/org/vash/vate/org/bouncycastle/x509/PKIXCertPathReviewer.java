...
import org.vash.vate.org.bouncycastle.asn1.ASN1IA5String;
...
import org.vash.vate.org.bouncycastle.asn1.x509.AccessDescription;
import org.vash.vate.org.bouncycastle.asn1.x509.AlgorithmIdentifier;
import org.vash.vate.org.bouncycastle.asn1.x509.AuthorityInformationAccess;
...
import org.vash.vate.org.bouncycastle.asn1.x509.GeneralSubtree;
import org.vash.vate.org.bouncycastle.asn1.x509.IssuingDistributionPoint;
import org.vash.vate.org.bouncycastle.asn1.x509.NameConstraints;
import org.vash.vate.org.bouncycastle.asn1.x509.PolicyInformation;
import org.vash.vate.org.bouncycastle.asn1.x509.qualified.Iso4217CurrencyCode;
import org.vash.vate.org.bouncycastle.asn1.x509.qualified.MonetaryValue;
import org.vash.vate.org.bouncycastle.asn1.x509.qualified.QCStatement;
import org.vash.vate.org.bouncycastle.i18n.ErrorBundle;
import org.vash.vate.org.bouncycastle.i18n.LocaleString;
import org.vash.vate.org.bouncycastle.i18n.filter.TrustedInput;
import org.vash.vate.org.bouncycastle.i18n.filter.UntrustedInput;
import org.vash.vate.org.bouncycastle.i18n.filter.UntrustedUrlInput;
import org.vash.vate.org.bouncycastle.jce.provider.AnnotatedException;
import org.vash.vate.org.bouncycastle.jce.provider.PKIXNameConstraintValidator;
import org.vash.vate.org.bouncycastle.jce.provider.PKIXNameConstraintValidatorException;
import org.vash.vate.org.bouncycastle.jce.provider.PKIXPolicyNode;
import org.vash.vate.org.bouncycastle.util.Integers;
import org.vash.vate.org.bouncycastle.util.Objects;

/**
 * PKIXCertPathReviewer 
 * Validation of X.509 Certificate Paths. Tries to find as much errors in the Path as possible.
 * @deprecated use org.vash.vate.org.bouncycastle.pkix.jcajce.PKIXCertPathReviewer in the bcpkix package
 */
public class PKIXCertPathReviewer extends CertPathValidatorUtilities
{
            ...
            throws CertPathReviewerException
    {
        ...
        List  cs = (List )certPath.getCertificates();
        if (cs.size() != 1)
        {
