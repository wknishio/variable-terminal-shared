...
import org.vash.vate.org.bouncycastle.asn1.x509.Target;
import org.vash.vate.org.bouncycastle.asn1.x509.TargetInformation;
import org.vash.vate.org.bouncycastle.asn1.x509.Targets;
import org.vash.vate.org.bouncycastle.util.Selector;

/**
 * This class is an  Selector</code> like implementation to select
 * attribute certificates from a given set of criteria.
 * 
 * @see org.vash.vate.org.bouncycastle.x509.X509AttributeCertificate
 * @see org.vash.vate.org.bouncycastle.x509.X509Store
 * @deprecated use org.vash.vate.org.bouncycastle.cert.X509AttributeCertificateSelector and org.vash.vate.org.bouncycastle.cert.X509AttributeCertificateSelectorBuilder.
 */
    ...
    implements Selector
{
     ...
     * @return  true</code> if the attribute certificate can be selected,
    ...
    /**
     * Set the attribute certificate to be matched. If  null</code> is
     * given any will do.
     * 
    ...
    /**
     * Set the time, when the certificate must be valid. If  null</code>
    ...
    /**
     * Sets the holder. If  null</code> is given any will do.
     * 
    ...
    /**
     * Sets the issuer the attribute certificate must have. If  null</code>
     * is given any will do.
     * 
     ...
     *  null</code> is given any will do.
     * 
     ...
     * information extension criteria. The  X509AttributeCertificate</code>
     ...
     *
     * @param name The name as a GeneralName (not  null</code>)
     */
    ...
    /**
     * Adds a collection with target names criteria. If  null</code> is
     * given any will do.
     * <p>
    ...
    /**
     * Gets the target names. The collection consists of  GeneralName</code>
     * objects.
     * <p>
     ...
     * and may be accepted by any server.
     *
     * @param group The group as GeneralName form (not  null</code>)
     */
    ...
    /**
     * Adds a collection with target groups criteria. If  null</code> is
     * given any will do.
     * <p>
     * The collection consists of  GeneralName</code> objects or  byte[]</code> representing DER
    ...
    /**
     * Gets the target groups. The collection consists of  GeneralName</code> objects.
     * <p>
     * The returned collection is immutable.
     *
