package org.vash.vate.org.bouncycastle.mozilla;
...
import org.vash.vate.org.bouncycastle.asn1.mozilla.PublicKeyAndChallenge;
...
{
    protected final org.vash.vate.org.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge          spkacSeq;

    public SignedPublicKeyAndChallenge(byte[] bytes)
    {
        spkacSeq = org.vash.vate.org.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge.getInstance(bytes);
    }

    protected SignedPublicKeyAndChallenge(org.vash.vate.org.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge struct)
    {
     ...
     */
    public org.vash.vate.org.bouncycastle.asn1.mozilla.SignedPublicKeyAndChallenge toASN1Structure()
    {
         return spkacSeq;
    }
