 ...
 *  
 *    The returned OutputStream must be closed to finalize encryption and authentication</li>
 *    Closing the returned stream <b>does not close</b> the underlying OutputStream passed to {@code open()}</li>
 *    Callers are responsible for closing the underlying OutputStream separately</li>
 * </ul>
 */
