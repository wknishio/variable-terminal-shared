...
import org.vash.vate.org.apache.commons.compress.compressors.lz77support.AbstractLZ77CompressorInputStream;
...
public class BlockLZ4CompressorInputStream extends AbstractLZ77CompressorInputStream {
    ...
    private boolean initializeBackReference() throws IOException {
        ...
        try {
            backReferenceOffset = (int) ByteUtils.fromLittleEndian(this, 2);
