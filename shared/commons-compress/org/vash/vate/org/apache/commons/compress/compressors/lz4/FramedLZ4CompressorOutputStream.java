...
public class FramedLZ4CompressorOutputStream extends CompressorOutputStream {
    ...
    public static class Parameters {
         ...
         */
        public static final Parameters DEFAULT = new Parameters(BlockSize.M4, false, false, false);
        private final BlockSize blockSize;
        private final boolean withContentChecksum, withBlockChecksum, withBlockDependency;

        private final org.vash.vate.org.apache.commons.compress.compressors.lz77support.Parameters lz77params;
        ...
        public Parameters(final BlockSize blockSize, final boolean withContentChecksum, final boolean withBlockChecksum,
                final boolean withBlockDependency,
                final org.vash.vate.org.apache.commons.compress.compressors.lz77support.Parameters lz77params) {
 ...
 doesn't close the underlying stream.
    ...
    private void flushBlock() throws IOException {
        ...
        BlockLZ4CompressorOutputStream closeable = null;
        try
        {
          closeable = new BlockLZ4CompressorOutputStream(baos, params.lz77params);
            if (withBlockDependency) {
              closeable.prefill(blockDependencyBuffer, blockDependencyBuffer.length - collectedBlockDependencyBytes,
                    collectedBlockDependencyBytes);
            }
            closeable.write(blockData, 0, currentIndex);
        }
        catch (Throwable t)
        {
