...
import org.vash.vate.org.apache.commons.compress.compressors.CompressorInputStream;
import org.vash.vate.org.apache.commons.compress.utils.BoundedInputStream;
import org.vash.vate.org.apache.commons.compress.utils.ByteUtils;
import org.vash.vate.org.apache.commons.compress.utils.CountingInputStream;
import org.vash.vate.org.apache.commons.compress.utils.IOUtils;
import org.vash.vate.org.apache.commons.compress.utils.InputStreamStatistics;
...
public class FramedLZ4CompressorInputStream extends CompressorInputStream
    ...
    public static boolean matches(final byte[] signature, final int length) {
        ...
        if (signature.length > LZ4_SIGNATURE.length) {
            shortenedSig = VTArrays.copyOf(signature, LZ4_SIGNATURE.length);
        }
    ...
    private void nextBlock() throws IOException {
        ...
        final long len = ByteUtils.fromLittleEndian(this, 4);
